...
import guiIzmenaiDodavanje.ServisAutomobilaServiserForma;
...
public class PrikazServisaServiser extends JFrame {
	...
	public PrikazServisaServiser(Servis servis, Serviser prijavljeniKorisnik) {
	...
	private void initActions() {
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ServisAutomobilaServiserForma sF = new ServisAutomobilaServiserForma(servis, null,null);
				sF.setVisible(true);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(red == -1) {
					...
					if(s != null && validacija2() == true) {
						ServisAutomobilaServiserForma sF = new ServisAutomobilaServiserForma(servis,prijavljeniKorisnik ,s);
						sF.setVisible(true);
					}else {

...
public class ServisAutomobilaServiserForma extends JFrame {
...
//	private JTextField txtTermin= new JTextField(20);
	...
	public ServisAutomobilaServiserForma(Servis servis,Serviser prijavljeniKorisnik,ServisAutomobila servisAutomobila) {
		this.servis = servis;
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//	ServisnaKnjizica servisnaKnjizica = servis.nadjiKnjizicu(knjiziceID);
					...
					ServisAutomobilaServiserForma.this.dispose();
					ServisAutomobilaServiserForma.this.setVisible(false);
				}

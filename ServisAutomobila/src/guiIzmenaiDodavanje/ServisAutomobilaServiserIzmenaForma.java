...
public class ServisAutomobilaServiserIzmenaForma extends JFrame {
...
//	private JTextField txtTermin= new JTextField(20);
	...
	private Serviser prijavljeniKorisnik;
	private Servis servis;
	private ServisAutomobila servisAutomobila;
	
	public ServisAutomobilaServiserIzmenaForma(Servis servis,Korisnici prijavljeniKorisnik2,ServisAutomobila servisAutomobila) {
		this.servis = servis;
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//	ServisnaKnjizica servisnaKnjizica = servis.nadjiKnjizicu(knjiziceID);
					...
					String idKnjizice = txtIdKnjizice.getText().trim();
					...
					ServisAutomobilaServiserIzmenaForma.this.dispose();
					ServisAutomobilaServiserIzmenaForma.this.setVisible(false);
				}

...
public class ServisAutomobilaMusterijaForma extends JFrame {
...
//	private JTextField txtTermin= new JTextField(20);
	...
	public ServisAutomobilaMusterijaForma(Servis servis,Musterija prijavljeniKorisnik,ServisAutomobila servisAutomobila) {
		this.servis = servis;
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//	ServisnaKnjizica servisnaKnjizica = servis.nadjiKnjizicu(knjiziceID);
					...
					ServisAutomobilaMusterijaForma.this.dispose();
					ServisAutomobilaMusterijaForma.this.setVisible(false);
				}
